...
protected:
	...
	virtual void Cmd_BlurMenuBackground(const CCommandBuffer::SCommand_BlurMenuBackground *pCommand) {}
	virtual void Cmd_RenderMenuGlass(const CCommandBuffer::SCommand_RenderMenuGlass *pCommand) {}
